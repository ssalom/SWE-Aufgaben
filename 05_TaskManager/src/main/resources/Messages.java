...
public enum Messages {
    ...
    SHOW_TASK_DIALOG_QUESTION2("Nummer der anzuzeigenden main.model.Task"),
    EDIT_TASK_DIALOG_QUESTION1("Bitte wählen Sie eine der folgenden Tasks aus um sie zu bearbeiten."),
    EDIT_TASK_DIALOG_QUESTION2("Nummer der zu bearbeitenden main.model.Task"),
    ...
    DELETE_TASK_DIALOG_QUESTION2("Nummer der zu löschenden main.model.Task"),
    DELETE_TASK_DIALOG_SUCCESS("main.model.Task mit der Nummer %s wurden Erfolgreich gelöscht"),
