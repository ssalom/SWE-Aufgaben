...
public class ItemDialog extends Dialog<Item> {
    ...
    public ItemDialog () {
        ...
        this.setHeaderText("Bitter füllen Sie die unterstehenden Felder entsprechend aus.");
        ...
        this.getDialogPane().getButtonTypes().add(buttonTypeSubmit);

        this.getDialogPane().setContent(gpane);
        this.setResultConverter(new Callback<ButtonType, Item>() {
            @Override
